 ...
 * 3. Помните. про инкапсуляцию. В методах store нельзя использовать методы c index,т.е. при реализации метода update вам необходимо найти в коллекции элемент с таким же id, как и переданный параметр, и если найден, то заменить его.
